...
<p>
  ...
  <img alt="Tests" src="https://img.shields.io/badge/Tests-132%20passed-green?style=flat-square">
...
核心设计：**LLM-first 深度推理 + 学术知识注入 + Block 系统安全执行 + Agent 驱动的诊断/解读/叙事 + 全链路无人值守自动化**。
...
| **132 测试覆盖** | 17 Agent 阶段测试 + 18 Block 测试 + 19 沙箱测试 + 其余模块测试 |
